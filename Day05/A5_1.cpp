...
public:
        ...
        Employee(string name, string address, Date birthdate, int eid, float salary, string dept, Date joining):Person(name, address, birthdate)
        {
        this->eid=eid;
        this->salary=salary;
        this->dept=dept;
...
int main()
{
        ...
        Employee e("Komal","Nagpur",d,2,2000,"Salary",j);
        e.display();
           return 0;
}
